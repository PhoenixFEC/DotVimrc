function! DotVimrc#utils#source_file(root_path,path, ...) abort
...
function! DotVimrc#utils#check_source(filename) abort
...
function! DotVimrc#utils#generate_coc_json() abort
